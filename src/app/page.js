      ...
      <div className="flex-1 overflow-hidden flex flex-col max-w-4xl mx-auto w-full px-4">
        ...
        <div className="border-t border-gray-200 bg-white/80 backdrop-blur-lg p-4">
          <div className="flex space-x-4">
            <input
              className="flex-1 rounded-lg border border-gray-300 px-4 py-3 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
              value={input}
